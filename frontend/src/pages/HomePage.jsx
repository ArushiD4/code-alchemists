  ...
  return (
    <div className="min-h-screen bg-oxford_blue text-white_custom">
      ...
      <div className="flex flex-col items-center justify-center min-h-[80vh] px-4">
        <h1 className="text-4xl font-bold mb-8 text-white">Verify Merchant Link</h1>
        <form onSubmit={handleSubmit} className="w-full max-w-2xl flex flex-col gap-6">
          ...
          />
          <button type="submit" disabled={loading} className="w-3/4 mx-auto py-4 rounded-full font-bold bg-[#d4af37] text-oxford_blue text-lg hover:scale-105 transition-all">
